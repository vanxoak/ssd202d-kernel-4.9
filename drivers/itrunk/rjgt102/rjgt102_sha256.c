/**
  ...
  * @version V1.00
  * @date    04-Feb-2015
  * @brief   This file contains the implementation of SHA-256 hashing algorithm.
  ********************************************************************************
  * @attention 
  *
  * 1> This code is presented "as is" without any guarantees.
  *
  * 2> SHA-256 is one of the three algorithms in the SHA2 specification. The others, 
  * SHA-384 and SHA-512, are not offered in this implementation.
  *
 ...
 */
void RJGT102_sha256_transform(sha256_ctx_t *ctx, const uint8_t *data)
{
...
/**@brief Function for initializing a @ref sha256_ctx_t instance.
 *
 * @param[out] ctx  Context instance to be initialized.
 *
 * @retval None 
 */
void RJGT102_sha256_init(sha256_ctx_t *ctx)
{
    ctx->datalen = 0;
    ctx->bitlen = 0;
 ...
 * @retval None 
 */
void RJGT102_sha256_update(sha256_ctx_t *ctx, const uint8_t *data, const size_t len)
{
    uint32_t i;
    ...
    for (i = 0; i < len; ++i) 
	{
        ...
        if (ctx->datalen == 64) 
		{
            RJGT102_sha256_transform(ctx, ctx->data);
            ctx->bitlen += 512;
            ctx->datalen = 0;
        }
    }
 ...
 * @retval None
 */
void RJGT102_sha256_final(sha256_ctx_t *ctx, uint8_t *hash)
{
	uint32_t i;
